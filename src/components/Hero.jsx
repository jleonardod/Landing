        ...
        <div>
          ...
          <div className="relative bg-white shadow-xl p-2 flex flex-col justify-center max-w-[250px] mx-auto gap-2 -mt-12">
            <div className="flex items-center">
              ...
              <img 
                src="https://img.freepik.com/foto-gratis/prospero-hombre-negocios-mantiene-manos-cruzadas-tiene-expresion-satisfecha_273609-16711.jpg" 
              ...
              <img 
                ...
                className="w-10 h-10 object-cover rounded-full ring-2 ring-gray-300 -ml-4"/>
              <img 
                src="https://img.freepik.com/foto-gratis/vista-lateral-hermosa-mujer-joven-piel-limpia-saludable-aspecto-natural-maquillaje-mirando-izquierda-sonriendo-pie-sobre-pared-blanca_176420-34093.jpg" 
                className="w-10 h-10 object-cover rounded-full ring-2 ring-gray-300 -ml-4"/>
              <img 
                src="https://img.freepik.com/fotos-premium/representacion-3d-personaje-masculino-barbudo-medio-cuerpo-anteojos-franela-roja_477250-77.jpg" 
                className="w-10 h-10 object-cover rounded-full ring-2 ring-gray-300 -ml-4"/>
            </div>
            <h2 className="font-bold text-xl tracking-[-1px] text-gray-800">120 + Employees</h2>
